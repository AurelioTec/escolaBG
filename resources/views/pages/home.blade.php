    ...
    <div class="row g-3">
        ...
        @php
            $cards = [
                ...
                ['icon' => 'check-circle', 'color' => 'success', 'title' => 'Matriculas Pedentes', 'value' => $inscriPendente],
                ['icon' => 'hourglass-half', 'color' => 'warning', 'title' => 'Novas', 'value' => $MatriNova],
                ['icon' => 'chalkboard-teacher', 'color' => 'danger', 'title' => 'Aluno / Turma', 'value' => "$total / $totalTurmasDif"],
                ['icon' => 'chalkboard-teacher', 'color' => 'primary', 'title' => 'Total de Turmas', 'value' => $totalTurmas],
                ['icon' => 'users', 'color' => 'dark', 'title' => 'Turmas com Alunos', 'value' => $turmaAlunosMatri],
                ['icon' => 'person-dress', 'color' => 'pink', 'title' => 'Feminino', 'value' => $countG],
                ['icon' => 'male', 'color' => 'primary', 'title' => 'Masculino', 'value' => $total - $countG],
                ['icon' => 'user-friends', 'color' => 'warning', 'title' => 'Total de Vagas', 'value' => $totalVagasRestantes],
            ];
        @endphp
